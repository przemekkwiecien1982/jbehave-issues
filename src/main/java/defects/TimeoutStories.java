 ...
 */
public class TimeoutStories extends JUnitStories {
    private Logger log =Logger.getLogger("dummy.test");

    public TimeoutStories() {
    ...
    public InjectableStepsFactory stepsFactory() {
        return new InstanceStepsFactory(configuration(), new DummySteps(log), new LoginSteps(log));
    }

    @Override
    protected List<String> storyPaths() {
        //return new StoryFinder().findPaths(codeLocationFromClass(this.getClass()), "**/*.story", "**/excluded*.story");
        return Arrays.asList("defects/stories/timeout/dummy1.story",
                "defects/stories/timeout/dummy2.story",
                "defects/stories/timeout/login.story");
