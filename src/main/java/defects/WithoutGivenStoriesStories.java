 ...
 */
public class WithoutGivenStoriesStories extends JUnitStories {
    private Logger log =Logger.getLogger("dummy.test");

    public WithoutGivenStoriesStories() {
    ...
    protected List<String> storyPaths() {
        ...
        return Arrays.asList("defects/stories/givenstories/withoutGivenStories.story");
